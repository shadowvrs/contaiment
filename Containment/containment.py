...
acid_jar = GameObject.GameObject("Acid Jar", 0, True, True, True, False, "A small metal container containg acid.")
...
note_login_info = GameObject.GameObject("Password Note", 0, True, True, True, False, "A small pice of paper with a passcode written on it.")
